...
class HybridTaskScoringCascadeRoIHead(CascadeRoIHead):
    def __init__(self,
                 num_stages,
                 stage_loss_weights,
                 ...
                 mask_iou_head=None,
                 **kwargs):
        super(HybridTaskScoringCascadeRoIHead,
    ...
    def _mask_forward_train(self,
        ...
        # mask iou scoring NOTE new added
        if stage != 2:              # mask sure that only 3rd stage has mask iou head
            return dict(loss_mask=loss_mask)

        mask_results = dict(mask_feats=mask_feats, mask_pred=mask_pred, 
                            mask_targets=mask_targets, loss_mask=loss_mask)     # NOTE not sure whether mask features is correct here
